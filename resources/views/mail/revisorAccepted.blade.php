...
<table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; color: #f35900; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 26px; "><strong>Congratulazioni</strong></h1>
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%;">La tua richiesta di diventare revisore è stata accolta! Cliccando sul seguente bottone potrai accedere al pannello per gestire le inserzioni. </p>
  </div>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:164px;" arcsize="11%"  stroke="f" fillcolor="#f35900"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Raleway',sans-serif;"><![endif]-->  
    <a href="{{route('admin')}}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Raleway',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f35900; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
      <span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Accedi alla sezione</span></span>
    </a>
...
<table id="u_content_text_deprecated_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 160%;">ATTENZIONE: Ti ricordiamo di seguito le linee che tutte le inserzioni devono necessariamente rispettare.</p>
<ul>
<li style="line-height: 22.4px;">Nel titolo, descrizione e in qualsiasi altro campo testuale non devono contenere ingiurie di nessun tipo, istigazione alla violenza, al razzismo, sessismo.</li>
<li style="line-height: 22.4px;">I campi devono contenere solo ed esclusivamente<br /> informazioni inerenti all'articolo in foto.</li>
<li style="line-height: 22.4px;">Se nelle immagini sono presenti volti devono necessariamente essere censurati.</li>
<li style="line-height: 22.4px;">Le immagini devono essere consone all'inserzione.</li>
<li style="line-height: 22.4px;">Le immagini non possono rappresentare armi, scene di violenza, razzismo, sessismo, satira e come indicato nel punto precedente devono essere strettamente coerenti con l'inserzione.</li>
</ul>
  </div>
